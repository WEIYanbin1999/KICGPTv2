...
with open('datasets/' + args.dataset + '/get_neighbor/relation2id.txt', 'r') as file:
...
for line in open('datasets/' + args.dataset + '/get_neighbor/train2id.txt', 'r'):
    head, relation, tail = line.strip('\n').split()
    train_triplet.append(list((int(head), int(relation), int(tail))))

for line in open('datasets/' + args.dataset + '/get_neighbor/test2id.txt', 'r'):
    head, relation, tail = line.strip('\n').split()
    # train_triplet.append(list((int(head), int(relation), int(tail))))
    test_triplet.append(list((int(head), int(relation), int(tail))))

for line in open('datasets/'+args.dataset+'/get_neighbor/valid2id.txt', 'r'):
    head, relation, tail = line.strip('\n').split()
    train_triplet.append(list((int(head), int(relation), int(tail))))
...
# Demonstration Pools
with open("datasets/" + args.dataset + "/demonstration/tail_supplement.txt", "w") as file:
    file.write(json.dumps(demonstrations_T_h, indent=1))

with open("datasets/" + args.dataset + "/demonstration/head_supplement.txt", "w") as file:
    file.write(json.dumps(demonstrations_T_t, indent=1))

with open("datasets/" + args.dataset + "/demonstration/tail_analogy.txt", "w") as file:
    file.write(json.dumps(demonstrations_T_r_query_tail, indent=1))

with open("datasets/" + args.dataset + "/demonstration/head_analogy.txt", "w") as file:
    file.write(json.dumps(demonstrations_T_r_query_head, indent=1))


# Other support files
with open("datasets/" + args.dataset + "/demonstration/T_link_base_head.txt", "w") as file:
    file.write(json.dumps(demonstrations_T_link_base_head, indent=1))

with open("datasets/" + args.dataset + "/demonstration/T_link_base_tail.txt", "w") as file:
    file.write(json.dumps(demonstrations_T_link_base_tail, indent=1))

with open("datasets/" + args.dataset + "/demonstration/all_r_triples.txt", "w") as file:
    file.write(json.dumps(all_r_triples, indent=1))

with open("datasets/" + args.dataset + "/link_base_id_tail.txt", "w") as file:
    file.write(json.dumps(demonstrations_T_link_base_id_tail, indent=1))

with open("datasets/" + args.dataset + "/link_base_id_head.txt", "w") as file:
    file.write(json.dumps(demonstrations_T_link_base_id_head, indent=1)) 
    
with open("datasets/" + args.dataset + "/test_answer.txt", "w") as file:
...
with open("datasets/" + args.dataset + "/filter_head.txt",'w') as load_f:
    load_f.write(json.dumps(all_answer_head, indent=1))
with open("datasets/" + args.dataset + "/filter_tail.txt",'w') as load_f:
