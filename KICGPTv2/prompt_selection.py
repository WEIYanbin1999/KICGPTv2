...
class Demon_sampler:
    ...
    def load_demonstration(self):
        with open("datasets/" + self.dataset + "/demonstration/"+ self.args.query +"_supplement.txt", "r") as f:
            supplement_pool = json.load(f)

        with open("datasets/" + self.dataset + "/demonstration/"+ self.args.query +"_analogy.txt", "r") as f:
    ...
    def shrink_link_base(self):
        with open("datasets/" + self.dataset + "/demonstration/"+ "T_link_base_"+ self.args.query +".txt", "r") as f:
    ...
    def load_ent_to_text(self):
            with open('datasets/' + self.dataset + '/entity2text.txt', 'r') as file:
